...
public class CoolingTowerScreen extends IEContainerScreen<DistillationTowerContainer>{
	static final ResourceLocation GUI_TEXTURE = new ResourceLocation("immersivenuclear", "textures/gui/coolingtower.png");
	
	CoolingTowerTileEntity tile;
	
	public CoolingTowerScreen(DistillationTowerContainer container, PlayerInventory playerInventory, ITextComponent title){
