...
public class Radiation extends SimpleAnimatedParticle{
	final double ogMotionY;
	final float red, green, blue;
	final float rotation;
	protected Radiation(ClientWorld world, double x, double y, double z, double motionX, double motionY, double motionZ, IAnimatedSprite spriteWithAge){
	...
	public static class Factory implements IParticleFactory<BasicParticleType>{
		...
		public Particle makeParticle(BasicParticleType typeIn, ClientWorld worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed){
			return new Radiation(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, this.spriteSet);
		}
	}
