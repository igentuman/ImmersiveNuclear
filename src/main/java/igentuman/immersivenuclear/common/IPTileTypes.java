...
public class IPTileTypes{
	...
	// Multiblocks
	public static final RegistryObject<TileEntityType<CoolingTowerTileEntity>> TOWER = register("coolingtower", CoolingTowerTileEntity::new, IPContent.Multiblock.distillationtower);
