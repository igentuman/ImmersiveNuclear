package igentuman.immersivenuclear.common.lubehandlers;
...
import igentuman.immersivenuclear.client.model.IPModel;
import igentuman.immersivenuclear.client.model.IPModels;
import igentuman.immersivenuclear.client.model.ModelLubricantPipes;
...
public class ExcavatorLubricationHandler implements LubricatedHandler.ILubricationHandler<ExcavatorTileEntity> {
	...
	public void spawnLubricantParticles(World world, AutoLubricatorTileEntity lubricator, Direction facing, ExcavatorTileEntity mbte){
		...
		for(int i = 0;i < 3;i++){
			...
			BlockState n = IPContent.Fluids.lubricant.block.getDefaultState();
	...
	private static final ResourceLocation TEXTURE = new ResourceLocation(ImmersiveNuclear.MODID, "textures/models/lube_pipe.png");
