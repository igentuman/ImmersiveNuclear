...
public class SulfurRecoveryRecipeCategory extends IPRecipeCategory<SulfurRecoveryRecipe>{
	public static final ResourceLocation ID = new ResourceLocation(ImmersiveNuclear.MODID, "hydrotreater");
	
	private final IDrawableStatic tankOverlay;
	public SulfurRecoveryRecipeCategory(IGuiHelper guiHelper){
		super(SulfurRecoveryRecipe.class, guiHelper, ID, "block.immersivenuclear.hydrotreater");
		ResourceLocation background = new ResourceLocation(ImmersiveNuclear.MODID, "textures/gui/jei/hydrotreater.png");
