 ...
 */
package igentuman.immersivenuclear.common.util.compat.crafttweaker.managers;
 ...
 *
 * @docParam this <recipetype:immersivenuclear:alloy>
 */
@ZenRegister
@Document("mods/immersivenuclear/AlloySmelter")
@ZenCodeType.Name("mods.immersivenuclear.AlloySmelter")
