...
public class CokerUnitRecipeCategory extends IPRecipeCategory<CokerUnitRecipe>{
	public static final ResourceLocation ID = new ResourceLocation(ImmersiveNuclear.MODID, "cokerunit");
	
	private final IDrawableStatic tankOverlay;
	public CokerUnitRecipeCategory(IGuiHelper guiHelper){
		super(CokerUnitRecipe.class, guiHelper, ID, "block.immersivenuclear.cokerunit");
		ResourceLocation background = new ResourceLocation(ImmersiveNuclear.MODID, "textures/gui/jei/coker.png");
		ResourceLocation coker = new ResourceLocation(ImmersiveNuclear.MODID, "textures/gui/coker.png");
