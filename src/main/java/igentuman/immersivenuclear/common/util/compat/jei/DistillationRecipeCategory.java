...
public class DistillationRecipeCategory extends IPRecipeCategory<DistillationRecipe>{
	...
	public DistillationRecipeCategory(IGuiHelper guiHelper){
		super(DistillationRecipe.class, guiHelper, ID, "block.immersivenuclear.distillationtower");
		ResourceLocation background = new ResourceLocation(ImmersiveNuclear.MODID, "textures/gui/distillation.png");
