...
@ZenRegister
@Document("mods/immersivenuclear/Coker")
@Name("mods.immersivenuclear.CokerUnit")
public class CokerUnitRecipeTweaker implements IRecipeManager{
	 ...
	 * 
	 * @param output
	 * @docParam output <item:immersivenuclear:petcoke>
	 ...
	 * 
	 * @param output <fluid:immersivenuclear:diesel>
	 */
	@Method
