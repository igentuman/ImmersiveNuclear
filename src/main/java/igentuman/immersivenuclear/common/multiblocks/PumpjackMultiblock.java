...
public class PumpjackMultiblock extends IETemplateMultiblock{
	...
	private PumpjackMultiblock(){
		super(new ResourceLocation(ImmersiveNuclear.MODID, "multiblocks/pumpjack"),
	...
	public void renderFormedStructure(MatrixStack transform, IRenderTypeBuffer buffer){
		...
		if(this.list != null && this.list.size() > 0){
			...
			if(world != null){
				...
				ImmersiveNuclear.proxy.renderTile(this.te, buffer.getBuffer(RenderType.getSolid()), transform, buffer);
				transform.pop();
