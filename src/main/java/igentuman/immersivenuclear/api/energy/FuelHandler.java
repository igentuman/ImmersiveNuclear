package igentuman.immersivenuclear.api.energy;

import java.util.HashMap;
import java.util.Map;

import igentuman.immersivenuclear.common.cfg.ConfigUtils;
...
public class FuelHandler{
	protected static final Logger log = LogManager.getLogger(ImmersiveNuclear.MODID + "/FuelHandler");
