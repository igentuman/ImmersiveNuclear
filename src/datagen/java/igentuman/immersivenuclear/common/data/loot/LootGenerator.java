package igentuman.immersivenuclear.common.data.loot;
	...
	public void act(DirectoryCache cache) throws IOException{
		...
		if(!problems.isEmpty()){
			problems.forEach((name, table) -> {
				ImmersiveNuclear.log.warn("Found validation problem in " + name + ": " + table);
			});
			...
			this.tables.forEach((name, table) -> {
				...
				try{
					...
					ImmersiveNuclear.log.error("Couldnt save loot table {}", out, e);
				}
			});
		}
	}
