...
import igentuman.immersivenuclear.api.crafting.builders.CokerUnitRecipeBuilder;
import igentuman.immersivenuclear.api.crafting.builders.DistillationRecipeBuilder;
import igentuman.immersivenuclear.api.crafting.builders.ReservoirTypeBuilder;
...
public class IPRecipes extends RecipeProvider{
	...
	private void speedboatUpgradeRecipes(){
		ShapedRecipeBuilder.shapedRecipe(IPContent.BoatUpgrades.reinforced_hull)
		...
		ShapedRecipeBuilder.shapedRecipe(IPContent.BoatUpgrades.ice_breaker)
			.key('P', IETags.getTagsFor(EnumMetals.STEEL).plate)
		...
		ShapedRecipeBuilder.shapedRecipe(IPContent.BoatUpgrades.tank)
		...
		ShapedRecipeBuilder.shapedRecipe(IPContent.BoatUpgrades.rudders)
			.key('P', IETags.getTagsFor(EnumMetals.IRON).plate)
		...
		ShapedRecipeBuilder.shapedRecipe(IPContent.BoatUpgrades.paddles)
	...
	private void blockRecipes(){
		...
		ShapedRecipeBuilder.shapedRecipe(IPContent.Blocks.asphalt_stair, 6)
		...
		ShapedRecipeBuilder.shapedRecipe(IPContent.Blocks.asphalt_slab, 6)
			.key('A', IPTags.getItemTag(IPTags.Blocks.asphalt))
			.patternLine("AAA")
			.addCriterion("has_bitumen", hasItem(IPContent.Items.bitumen))
			.addCriterion("has_slag", hasItem(IEItems.Ingredients.slag))
		...
		FluidAwareShapedRecipeBuilder.builder(IPContent.Blocks.asphalt, 1)
			.key('S', IPContent.Blocks.asphalt_slab)
			.patternLine("S")
			.patternLine("S")
			.addCriterion("has_bitumen", hasItem(IPContent.Items.bitumen))
			.addCriterion("has_slag", hasItem(IEItems.Ingredients.slag))
		...
		SingleItemRecipeBuilder.stonecuttingRecipe(Ingredient.fromItems(IPContent.Blocks.asphalt), IPContent.Blocks.asphalt_slab, 2)
			.addCriterion("has_asphalt", hasItem(IPContent.Blocks.asphalt))
			.build(this.out, "asphalt_slab_from_asphalt_stonecutting");
		
		SingleItemRecipeBuilder.stonecuttingRecipe(Ingredient.fromItems(IPContent.Blocks.asphalt), IPContent.Blocks.asphalt_stair)
			.addCriterion("has_asphalt", hasItem(IPContent.Blocks.asphalt))
		...
		ShapedRecipeBuilder.shapedRecipe(IPContent.Blocks.auto_lubricator)
