...
import igentuman.immersivenuclear.common.blocks.IEBaseBlock;
import igentuman.immersivenuclear.common.blocks.metal.ConveyorBlock;
import igentuman.immersivenuclear.common.blocks.metal.MetalLadderBlock.CoverType;
import igentuman.immersivenuclear.common.blocks.metal.MetalScaffoldingType;
import igentuman.immersivenuclear.common.blocks.wooden.TreatedWoodStyles;
import igentuman.immersivenuclear.common.config.IEServerConfig;
import igentuman.immersivenuclear.common.crafting.fluidaware.IngredientFluidStack;
import igentuman.immersivenuclear.common.items.BulletItem;
import igentuman.immersivenuclear.common.items.ToolUpgradeItem.ToolUpgrade;
...
import igentuman.immersivenuclear.common.register.INItems.*;
import igentuman.immersivenuclear.common.util.ItemNBTHelper;
import igentuman.immersivenuclear.common.util.RecipeSerializers;
import igentuman.immersivenuclear.data.recipebuilder.*;
import igentuman.immersivenuclear.data.resources.RecipeMetals;
import igentuman.immersivenuclear.data.resources.RecipeMetals.AlloyProperties;
import igentuman.immersivenuclear.data.resources.RecipeOres;
import igentuman.immersivenuclear.data.resources.RecipeWoods;
import igentuman.immersivenuclear.data.resources.SecondaryOutput;
...
public class Recipes extends RecipeProvider
{
	...
	protected void buildRecipes(Consumer<FinishedRecipe> out)
	{
		for(EnumMetals metal : EnumMetals.values())
		{
			...
			BlockEntry<Block> block = INBlocks.Metals.STORAGE.get(metal);
			BlockEntry<IEBaseBlock> sheetMetal = INBlocks.Metals.SHEETMETAL.get(metal);
			...
			{
				BlockEntry<Block> ore = INBlocks.Metals.ORES.get(metal);
				...
				BlockEntry<Block> rawBlock = INBlocks.Metals.RAW_ORES.get(metal);
...
//			addStandardSmeltingBlastingRecipe(dust, ingot, metal.smeltingXP, out, "_from_dust"); //TODO: remove this, if 0 XP on dust is intentional. this bugs out because the alloys do not have metal.smeltingXP
		...
		addStandardSmeltingBlastingRecipe(INItems.Ingredients.DUST_HOP_GRAPHITE, Ingredients.INGOT_HOP_GRAPHITE, 0.5F, out);
		...
		for(Entry<ResourceLocation, BlockEntry<SlabBlock>> blockSlab : INBlocks.TO_SLAB.entrySet())
	...
	private void recipesCloche(@Nonnull Consumer<FinishedRecipe> out)
	{
		...
		ClocheRecipeBuilder.builder(Ingredients.HEMP_FIBER)
				...
				.addSoil(Blocks.DIRT)
				.setTime(800)
				.setRender(new ClocheRenderReference("hemp", INBlocks.Misc.HEMP_PLANT.get()))
	...
	private void recipesBlueprint(@Nonnull Consumer<FinishedRecipe> out)
	{
		...
		BlueprintCraftingRecipeBuilder.builder("bannerpatterns", INBannerPatterns.WOLF.item())
	...
	private void recipesStoneDecorations(@Nonnull Consumer<FinishedRecipe> out)
	{
		...
		add3x3Conversion(StoneDecoration.COKE, INItems.Ingredients.COAL_COKE, IETags.coalCoke, out);
		...
		addStonecuttingRecipe(StoneDecoration.SLAG_BRICK, INBlocks.TO_SLAB.get(StoneDecoration.SLAG_BRICK.getId()), 2, out);
		addStonecuttingRecipe(StoneDecoration.SLAG_BRICK, INBlocks.TO_STAIRS.get(StoneDecoration.SLAG_BRICK.getId()), out);
		addStonecuttingRecipe(StoneDecoration.SLAG_BRICK, INBlocks.TO_WALL.get(StoneDecoration.SLAG_BRICK.getId()), out);
		addStonecuttingRecipe(StoneDecoration.CLINKER_BRICK, INBlocks.TO_SLAB.get(StoneDecoration.CLINKER_BRICK.getId()), 2, out);
		addStonecuttingRecipe(StoneDecoration.CLINKER_BRICK, INBlocks.TO_STAIRS.get(StoneDecoration.CLINKER_BRICK.getId()), out);
		addStonecuttingRecipe(StoneDecoration.CLINKER_BRICK, INBlocks.TO_WALL.get(StoneDecoration.CLINKER_BRICK.getId()), out);
		addStonecuttingRecipe(StoneDecoration.HEMPCRETE, INBlocks.TO_SLAB.get(StoneDecoration.HEMPCRETE.getId()), 2, out);
		addStonecuttingRecipe(StoneDecoration.HEMPCRETE, INBlocks.TO_STAIRS.get(StoneDecoration.HEMPCRETE.getId()), out);
		addStonecuttingRecipe(StoneDecoration.HEMPCRETE_BRICK, INBlocks.TO_SLAB.get(StoneDecoration.HEMPCRETE_BRICK.getId()), 2, out);
		addStonecuttingRecipe(StoneDecoration.HEMPCRETE_BRICK, INBlocks.TO_STAIRS.get(StoneDecoration.HEMPCRETE_BRICK.getId()), out);
		addStonecuttingRecipe(StoneDecoration.CONCRETE, INBlocks.TO_SLAB.get(StoneDecoration.CONCRETE.getId()), 2, out);
		addStonecuttingRecipe(StoneDecoration.CONCRETE, INBlocks.TO_STAIRS.get(StoneDecoration.CONCRETE.getId()), out);
		...
		addStonecuttingRecipe(StoneDecoration.CONCRETE_BRICK, INBlocks.TO_SLAB.get(StoneDecoration.CONCRETE_BRICK.getId()), 2, out);
		addStonecuttingRecipe(StoneDecoration.CONCRETE_BRICK, INBlocks.TO_STAIRS.get(StoneDecoration.CONCRETE_BRICK.getId()), out);
		addStonecuttingRecipe(StoneDecoration.CONCRETE_TILE, INBlocks.TO_SLAB.get(StoneDecoration.CONCRETE_TILE.getId()), 2, out);
		addStonecuttingRecipe(StoneDecoration.CONCRETE_TILE, INBlocks.TO_STAIRS.get(StoneDecoration.CONCRETE_TILE.getId()), out);
		addStonecuttingRecipe(StoneDecoration.CONCRETE_LEADED, INBlocks.TO_SLAB.get(StoneDecoration.CONCRETE_LEADED.getId()), 2, out);
		addStonecuttingRecipe(StoneDecoration.CONCRETE_LEADED, INBlocks.TO_STAIRS.get(StoneDecoration.CONCRETE_LEADED.getId()), out);
	...
	private void recipesWoodenDecorations(@Nonnull Consumer<FinishedRecipe> out)
	{
		...
		FluidAwareShapedRecipeBuilder.builder(WoodenDecoration.TREATED_WOOD.get(TreatedWoodStyles.HORIZONTAL), 8)
				...
				.unlockedBy("has_creosote", has(INFluids.CREOSOTE.getBucket()))
		...
		FluidAwareShapedRecipeBuilder.builder(WoodenDecoration.FIBERBOARD, 8)
				...
				.unlockedBy("has_resin", has(INFluids.PHENOLIC_RESIN.getBucket()))
	...
	private void recipesMetalDevices(@Nonnull Consumer<FinishedRecipe> out)
	{
		...
		shapedMisc(MetalDevices.BARREL)
				...
				.define('s', INBlocks.TO_SLAB.get(INBlocks.Metals.SHEETMETAL.get(EnumMetals.IRON).getId()))
				.unlockedBy("has_iron_sheet_slab", has(INBlocks.Metals.SHEETMETAL.get(EnumMetals.IRON)))
		...
		shapedMisc(MetalDevices.FLUID_PUMP)
				...
				.define('p', INBlocks.MetalDevices.FLUID_PIPE)
				.unlockedBy("has_"+toPath(INBlocks.MetalDevices.FLUID_PIPE), has(INBlocks.MetalDevices.FLUID_PIPE))
	...
	{
		shapedMisc(INBlocks.Connectors.BREAKER_SWITCH)
				.pattern(" l ")
				.pattern("cic")
		...
		shapedMisc(INBlocks.Connectors.REDSTONE_BREAKER)
				.pattern("hrh")
				.pattern("ici")
		...
		shapedMisc(INBlocks.Connectors.CURRENT_TRANSFORMER)
				.pattern(" m ")
				.pattern(" b ")
				.pattern("iei")
				.define('m', INItems.Tools.VOLTMETER)
				.define('b', IETags.connectorInsulator)
				.define('i', IETags.getTagsFor(EnumMetals.IRON).ingot)
				.define('e', Ingredients.COMPONENT_ELECTRONIC)
				.unlockedBy("has_voltmeter", has(INItems.Tools.VOLTMETER))
				.save(out, toRL(toPath(Connectors.CURRENT_TRANSFORMER)));

		shapedMisc(INBlocks.Connectors.TRANSFORMER)
				.pattern("lm")
				.pattern("eb")
				.pattern("ii")
				.define('l', INBlocks.Connectors.getEnergyConnector(WireType.LV_CATEGORY, false))
				.define('m', INBlocks.Connectors.getEnergyConnector(WireType.MV_CATEGORY, false))
				.define('e', Ingredients.COMPONENT_ELECTRONIC)
				.define('b', MetalDecoration.MV_COIL)
				.define('i', IETags.getTagsFor(EnumMetals.IRON).ingot)
				.unlockedBy("has_mv_connector", has(INBlocks.Connectors.getEnergyConnector(WireType.MV_CATEGORY, false)))
				.save(out, toRL(toPath(Connectors.TRANSFORMER)));
		shapedMisc(INBlocks.Connectors.TRANSFORMER_HV)
				.pattern("mh")
				.pattern("eb")
				.pattern("ii")
				.define('m', INBlocks.Connectors.getEnergyConnector(WireType.MV_CATEGORY, false))
		...
		shapedMisc(INBlocks.Connectors.CONNECTOR_STRUCTURAL, 8)
				.pattern("isi")
				.pattern("i i")
				.define('i', IETags.getTagsFor(EnumMetals.STEEL).ingot)
				.define('s', IETags.steelRod)
		...
		shapedMisc(INBlocks.Connectors.CONNECTOR_REDSTONE, 4)
				.pattern("iii")
				.pattern("brb")
		...
		shapedMisc(INBlocks.Connectors.CONNECTOR_PROBE)
				.pattern(" c ")
				.pattern("gpg")
		...
		shapedMisc(INBlocks.Connectors.CONNECTOR_BUNDLED)
				.pattern(" w ")
				.pattern("wcw")
				.pattern(" w ")
				.define('c', Connectors.CONNECTOR_REDSTONE)
	...
	private void recipesCloth(@Nonnull Consumer<FinishedRecipe> out)
	{
		shapedMisc(Cloth.BALLOON, 2)
				...
				.pattern("ftf")
				.pattern(" s ")
				.define('f', INItems.Ingredients.HEMP_FABRIC)
	...
	private void recipesTools(@Nonnull Consumer<FinishedRecipe> out)
	{
		...
		shapedMisc(Tools.TOOLBOX)
				...
				.define('c', INBlocks.WoodenDevices.CRATE)
				.unlockedBy("has_iron_ingot", has(IETags.getTagsFor(EnumMetals.IRON).ingot))
				.unlockedBy("has_red_dye", has(Items.RED_DYE))
				.unlockedBy("has_"+toPath(INBlocks.WoodenDevices.CRATE), has(INBlocks.WoodenDevices.CRATE))
	...
	private void recipesIngredients(@Nonnull Consumer<FinishedRecipe> out)
	{
		...
		shapedMisc(Misc.TOOL_UPGRADES.get(ToolUpgrade.SHIELD_SHOCK))
				...
				.define('c', INBlocks.Connectors.getEnergyConnector(WireType.LV_CATEGORY, false))
				.unlockedBy("has_shield", has(Misc.SHIELD))
		...
		ShapelessRecipeBuilder acidBaseRecipe = shapelessMisc(INFluids.REDSTONE_ACID.getBucket())
	...
	private void recipesMisc(@Nonnull Consumer<FinishedRecipe> out)
	{
		...
		shapedMisc(Misc.POWERPACK)
				...
				.unlockedBy("has_"+toPath(INBlocks.Connectors.getEnergyConnector(WireType.LV_CATEGORY, false)), has(INBlocks.Connectors.getEnergyConnector(WireType.LV_CATEGORY, false)))
		...
		shapelessMisc(Items.WHITE_DYE, 16)
				...
				.unlockedBy("has_ethanol", has(INFluids.ETHANOL.getBucket()))
	...
	{
		ItemLike stairs = INBlocks.TO_STAIRS.get(BuiltInRegistries.ITEM.getKey(block.asItem()));
		shapedMisc(stairs, 4)
				.define('s', block)
				.pattern("s  ")
				.pattern("ss ")
	...
	{
		ItemLike wall = INBlocks.TO_WALL.get(BuiltInRegistries.ITEM.getKey(block.asItem()));
		shapedMisc(wall, 6)
				.define('s', block)
				.pattern("sss")
				.pattern("sss")
