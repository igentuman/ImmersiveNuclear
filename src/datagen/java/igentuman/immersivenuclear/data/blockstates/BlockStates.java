...
import igentuman.immersivenuclear.client.models.ModelConfigurableSides.Type;
import igentuman.immersivenuclear.common.blocks.IEEntityBlock;
import igentuman.immersivenuclear.common.blocks.cloth.StripCurtainBlock;
import igentuman.immersivenuclear.common.blocks.generic.WallmountBlock;
import igentuman.immersivenuclear.common.blocks.generic.WallmountBlock.Orientation;
...
import igentuman.immersivenuclear.data.models.ModelProviderUtils;
import igentuman.immersivenuclear.data.models.SideConfigBuilder;
...
public class BlockStates extends ExtendedBlockstateProvider
{
	...
	protected void registerStatesAndModels()
	{
		...
		for(INFluids.FluidEntry entry : INFluids.ALL_ENTRIES)
		{
	...
	private void createHemp()
	{
		...
		ModelFile model = models()
				...
				.texture("crop", new ResourceLocation(ImmersiveNuclear.MODID, "block/hemp/top0"))
				.renderType(ModelProviderUtils.getName(cutout()));
		...
		for(int i = 0; i <= 4; i++)
		{
			model = models()
					...
					.texture("crop", new ResourceLocation(ImmersiveNuclear.MODID, "block/hemp/bottom"+i))
					.renderType(ModelProviderUtils.getName(cutout()));
	...
	private void createSawdust()
	{
		...
		ResourceLocation sawdustTexture = new ResourceLocation(ImmersiveNuclear.MODID, "block/wooden_decoration/sawdust");
